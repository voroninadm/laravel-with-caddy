...
class RecyclingTasksMiddleware
{
    ...
    private function checkPermissions(Request $request): bool
    {
        ...
        if ($user->hasPermissionTo('medium_recycling_permission') && $timeDifference <= 48) {
            return true;
        } elseif ($user->hasPermissionTo('full_recycling_permission')) {
            return true;
        }
        return false;
    }
