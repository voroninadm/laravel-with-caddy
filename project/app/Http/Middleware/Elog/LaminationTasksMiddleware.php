...
class LaminationTasksMiddleware
{
    ...
    private function checkPermissions(Request $request): bool
    {
        ...
        if ($user->hasPermissionTo('medium_lamination_permission') && $timeDifference <= 48) {
            return true;
        } elseif ($user->hasPermissionTo('full_lamination_permission')) {
            return true;
        }
        return false;
    }
