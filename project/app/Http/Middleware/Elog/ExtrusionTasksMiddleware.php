...
class ExtrusionTasksMiddleware
{
    ...
    private function checkPermissions(Request $request): bool
    {
        ...
        if ($user->hasPermissionTo('medium_extrusion_permission') && $timeDifference <= 48) {
            return true;
        } elseif ($user->hasPermissionTo('full_extrusion_permission')) {
            return true;
        }
        return false;
    }
