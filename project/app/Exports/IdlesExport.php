...
class IdlesExport implements FromView, WithStyles, ShouldAutoSize
{
    use Exportable;
    ...
    public function __construct($data, $work_start, $work_finish)
    {
        $this->data = $data;
    ...
    {
        return view('ExcelExports/idles', [
            'data' => $this->data,
    ...
    public function styles(Worksheet $sheet): array
    {
        return [
            ...
            ($sheet->getHighestRow()) => [
                'fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => 'FFDDDD']], // Red background
            ],
